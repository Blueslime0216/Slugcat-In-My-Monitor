...
* **먹이 주기:** 트레이에서 선택한 Slugcat에게 파란 열매를 주고 자율 섭취 관찰
...
* **트레이 아이콘 우클릭 → 먹이 주기 → 파란 열매 주기:** 선택한 Slugcat 앞에 먹이 놓기
...
* **Feeding:** Give the selected Slugcat a Dangle Fruit from the tray and watch it eat autonomously
...
* **Right-click the tray icon → Feed → Give Dangle Fruit:** Place food near the selected Slugcat
